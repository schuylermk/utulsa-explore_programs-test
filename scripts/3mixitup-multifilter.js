    ...
    var e = function(u) {
        ...
        u.ConfigCallbacks.registerAction("afterConstruct", "multifilter", function() {
            ...
            enableButtons: function() {
                var u = this.dom.form.querySelectorAll('button[type="submit"]:disabled'),
                    e = null,
                    t = -1;
                for (t = 0; e = u[t]; t++) e.disabled && (e.disabled = !1)
            },
            bindEvents: function() {
                var u = this;
            ...
            handleClick: function(u) {
                var e, t = this,
                    r = t.mixer,
                    o = i.closestParent(u.target, "[data-filter], [data-toggle]", !0),
                    l = -1,
                    E = "";
                o && ((e = t.mixer.config.selectors.control) && !o.matches(e) || (u.stopPropagation(), r.lastClicked || (r.lastClicked = o), "function" == typeof r.config.callbacks.onMixClick && !1 === r.config.callbacks.onMixClick.call(r.lastClicked, r.state, u, t) || (o.matches("[data-filter]") ? (E = o.getAttribute("data-filter"), t.activeToggles = [], t.activeSelectors = t.activeFilters = [E]) : o.matches("[data-toggle]") && (E = o.getAttribute("data-toggle"), t.activeFilters = [], (l = t.activeToggles.indexOf(E)) > -1 ? t.activeToggles.splice(l, 1) : t.activeToggles.push(E), "and" === t.logic ? t.activeSelectors = [t.activeToggles] : t.activeSelectors = t.activeToggles), t.updateControls(), "change" === t.mixer.config.multifilter.parseOn && t.mixer.parseFilterGroups())))
            },
            ...
            handleKeyup: function(u) {
                var e = this,
                    t = u.target;
                ["text", "search", "email"].indexOf(t.type) < 0 || ("change" === e.mixer.config.multifilter.parseOn ? (clearTimeout(e.keyupTimeout), e.keyupTimeout = setTimeout(function() {
                    e.getSingleValue(t), e.mixer.parseFilterGroups()
                }, e.mixer.config.multifilter.keyupThrottleDuration)) : e.mixer.getSingleValue(t))
            },
            handleFormEvent: function(e) {
                ...
                if ("submit" === e.type && e.preventDefault(), "reset" === e.type && (t.activeFilters = t.activeToggles = t.activeSelectors = [], t.updateControls()), t.mixer.multifilterFormEventTracker) i = t.mixer.multifilterFormEventTracker;
                    ...
                    for ((i = t.mixer.multifilterFormEventTracker = new u.MultifilterFormEventTracker).form = e.target, o = 0; r = t.mixer.filterGroups[o]; o++) r.dom.form === e.target && i.totalBound++;
            ...
            getSingleValue: function(u) {
                ...
                if (u.type.match(/text|search|email/g)) {
                    if (!(r = u.getAttribute("data-search-attribute"))) throw new Error("[MixItUp MultiFilter] A valid `data-search-attribute` must be present on text inputs");
                    ...
                    for (l = u.value.toLowerCase().trim(), E = 0; i = t[E]; E++) l = l.replace(i[1], i[0]);
                    o = "[" + r + '*="' + (l = l.replace(/\W+/g, " ")) + '"]'
                } else o = u.value;
                "string" == typeof u.value && (e.activeSelectors = e.activeToggles = e.activeFilters = o ? [o] : [])
            },
            getMultipleValues: function(u) {
                ...
                for (e = t.dom.el.querySelectorAll(r), l = 0; o = e[l]; l++)(o.checked || o.selected) && o.value && i.push(o.value);
                t.activeFilters = [], t.activeToggles = i, "and" === t.logic ? t.activeSelectors = [i] : t.activeSelectors = i
            },
            updateControls: function(u) {
                var e, t, i = this,
                    ...
                    o = "",
                    l = -1;
                for (t = ["[data-filter]" + (e = i.mixer.config.selectors.control.trim()), "[data-toggle]" + e].join(", "), u = u || i.dom.el.querySelectorAll(t), l = 0; r = u[l]; l++) o = Boolean(r.getAttribute("data-toggle")) ? "toggle" : "filter", i.updateControl(r, o)
            },
            updateControl: function(u, e) {
                var t, r = u.getAttribute("data-" + e),
                    o = this.activeToggles.concat(this.activeFilters);
                t = i.getClassname(this.mixer.config.classNames, e, this.mixer.config.classNames.modifierActive), o.indexOf(r) > -1 ? i.addClass(u, t) : i.removeClass(u, t)
            },
            updateUi: function() {
                var u = this,
                    ...
                    o = null,
                    l = -1;
                for (e.length && u.updateControls(e, !0), l = 0; o = t[l]; l++) switch (r = i.indexOf(o.value) > -1, o.tagName.toLowerCase()) {
                    case "option":
                        o.selected = r;
                        break;
                    case "input":
            ...
            var u = null,
                e = -1;
            for (e = 0; u = this.filterGroups[e]; e++) u.updateControls()
        }), u.Mixer.registerAction("beforeDestroy", "multifilter", function() {
            var u = null,
                e = -1;
            for (e = 0; u = this.filterGroups[e]; e++) u.unbindEvents()
        }), u.Mixer.extend({
            indexFilterGroups: function() {
                ...
                for (r = 0; i = e.dom.filterGroups[r]; r++)
                    if ((t = new u.FilterGroup).init(i, e), e.filterGroups.push(t), t.name) {
                        if (void 0 !== e.filterGroupsHash[t.name]) throw new Error('[MixItUp MultiFilter] A filter group with name "' + t.name + '" already exists');
                        e.filterGroupsHash[t.name] = t
                    }
            },
            parseParseFilterGroupsArgs: function(e) {
                var t = new u.UserInstruction,
                    r = null,
                    o = -1;
                for (t.animate = this.config.animation.enable, t.command = new u.CommandFilter, o = 0; o < e.length; o++) "boolean" == typeof(r = e[o]) ? t.animate = r : "function" == typeof r && (t.callback = r);
                return i.freeze(t), t
            },
            getFilterGroupPaths: function() {
                var u, e = null,
                    ...
                    l = [],
                    E = -1;
                for (E = 0; E < this.filterGroups.length; E++)(t = this.filterGroups[E].activeSelectors).length && (r.push(t), l.push(0));
                return u = function() {
                    var u = null,
                        e = [],
                        t = -1;
                    for (t = 0; t < r.length; t++) u = r[t][l[t]], Array.isArray(u) && (u = u.join("")), e.push(u);
                    e = i.clean(e), o.push(e)
                }, e = function(t) {
                    for (var i = r[t = t || 0]; l[t] < i.length;) t < r.length - 1 ? e(t + 1) : u(), l[t]++;
                    l[t] = 0
                }, r.length ? (e(), o) : ""
            },
            buildSelectorFromPaths: function(u) {
                var e = [],
                    ...
                    r = -1;
                if (!u.length) return "";
                if ("or" === this.config.multifilter.logicBetweenGroups && (i = ", "), u.length > 1) {
                    for (r = 0; r < u.length; r++) t = u[r].join(i), e.indexOf(t) < 0 && e.push(t);
                    return e.join(", ")
                }
                return u[0].join(i)
            },
            parseFilterGroups: function() {
                var u = this,
                    ...
                    r = null,
                    o = {};
                return "" === i && (i = u.config.controls.toggleDefault), e.command.selector = i, o.filter = e.command, "function" == typeof(r = u.config.callbacks.onParseFilterGroups) && (o = r(o)), u.multimix(o, e.animate, e.callback)
            },
            setFilterGroupSelectors: function(u, e) {
                var t = null;
                if (e = Array.isArray(e) ? e : [e], void 0 === (t = this.filterGroupsHash[u])) throw new Error('[MixItUp MultiFilter] No filter group could be found with the name "' + u + '"');
                t.activeToggles = e.slice(), "and" === t.logic ? t.activeSelectors = [t.activeToggles] : t.activeSelectors = t.activeToggles, t.updateUi(t.activeToggles)
            },
            getFilterGroupSelectors: function(u) {
                var e = null;
                if (void 0 === (e = this.filterGroupsHash[u])) throw new Error('[MixItUp MultiFilter] No filter group could be found with the name "' + u + '"');
